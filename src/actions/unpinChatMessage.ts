...
const UNPIN_CHAT_MESSAGE_ERROR = "UNPIN_CHAT_MESSAGE_ERROR";
const UNPIN_CHAT_MESSAGE_QUERY = "UNPIN_CHAT_MESSAGE_QUERY";
const UNPIN_CHAT_MESSAGE_RESULT = "UNPIN_CHAT_MESSAGE_RESULT";
