...
const SEND_CHAT_ACTION_ERROR: string = "SEND_CHAT_ACTION_ERROR";
const SEND_CHAT_ACTION_QUERY: string = "SEND_CHAT_ACTION_QUERY";
const SEND_CHAT_ACTION_RESULT: string = "SEND_CHAT_ACTION_RESULT";
