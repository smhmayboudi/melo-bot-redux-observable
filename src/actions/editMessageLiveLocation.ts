...
const EDIT_MESSAGE_LIVE_LOCATION_ERROR = "EDIT_MESSAGE_LIVE_LOCATION_ERROR";
const EDIT_MESSAGE_LIVE_LOCATION_QUERY = "EDIT_MESSAGE_LIVE_LOCATION_QUERY";
const EDIT_MESSAGE_LIVE_LOCATION_RESULT = "EDIT_MESSAGE_LIVE_LOCATION_RESULT";
