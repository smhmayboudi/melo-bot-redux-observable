...
const KICK_CHAT_MEMBER_ERROR = "KICK_CHAT_MEMBER_ERROR";
const KICK_CHAT_MEMBER_QUERY = "KICK_CHAT_MEMBER_QUERY";
const KICK_CHAT_MEMBER_RESULT = "KICK_CHAT_MEMBER_RESULT";
